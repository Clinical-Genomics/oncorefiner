...
| `pipelines_testdata_base_path` | Base URL or local path to location of pipeline test dataset files | `string` | https://raw.githubusercontent.com/Clinical-Genomics/test-datasets/759e235ed7e8530bcfda07287388f29fb131a024/ |  | True |
