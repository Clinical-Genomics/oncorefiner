...
| `pipelines_testdata_base_path` | Base URL or local path to location of pipeline test dataset files | `string` | /Users/kristinebilgrav/Development/test-datasets/ |  | True |
