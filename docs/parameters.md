...
| `pipelines_testdata_base_path` | Base URL or local path to location of pipeline test dataset files | `string` | https://raw.githubusercontent.com/Clinical-Genomics/test-datasets/77798d5310101923d41a184e22fd2e3f3391857d/ |  | True |
