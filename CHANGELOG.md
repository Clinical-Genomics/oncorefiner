...
- Added bam and bai parameters for tumor and normal samples, and logic in `PREPARE_REFERENCES` subworkflow to create joint bam_bai channels [#61](https://github.com/Clinical-Genomics/oncorefiner/pull/61)
