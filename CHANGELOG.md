...
- Updated PR template, PR checklist, Feature request template, Bug report template and issue template chooser [#23](https://github.com/Clinical-Genomics/oncorefiner/pull/24)
