...
- Updated linting config to fix linting issues and add/remove checks for nf-core file structure that is no longer required [#35](https://github.com/Clinical-Genomics/oncorefiner/pull/35)
