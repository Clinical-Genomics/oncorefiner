...
- [#126](https://github.com/Clinical-Genomics/oncorefiner/pull/126) Added the nf-core modules `rmarkdownnotebook`
- [#126](https://github.com/Clinical-Genomics/oncorefiner/pull/126) Added the subworkflow `PROCESS_CNVS` along with subworkflow tests.
...
- [#126](https://github.com/Clinical-Genomics/oncorefiner/pull/126) Updated config test files to include parameters for `PROCESS_CNVS`
