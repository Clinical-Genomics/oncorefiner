...
- [#169](https://github.com/Clinical-Genomics/oncorefiner/pull/169/) Populated the `ch_bam_bai_normal` in `PROCESS_SVS` and updated the meta structure of the two bam channels, which also updated the naming of the .cgh file.
