...
- Update pipelines_testdata_base_path and fixed overriding bug by removing redundant declaration in `tests/nextflow.config` [#68](https://github.com/Clinical-Genomics/oncorefiner/pull/68)
